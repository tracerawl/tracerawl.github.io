...
Webflow.require('ix').init([
  ...
  {"slug":"fade-in-on-load","name":"Fade in on Load","value":{"style":{"opacity":0,"x":"0px","y":"-10px","z":"0px"},"triggers":[{"type":"load","stepsA":[{"wait":200},{"opacity":1,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","x":"0px","y":"0px","z":"0px"}],"stepsB":[]}]}},
  ...
  {"slug":"fade-in-on-load-3","name":"Fade in on Load 3","value":{"style":{"opacity":0,"x":"0px","y":"-10px","z":"0px"},"triggers":[{"type":"load","stepsA":[{"wait":700},{"opacity":1,"transition":"opacity 500ms ease 0, transform 500ms ease 0","x":"0px","y":"0px","z":"0px"}],"stepsB":[]}]}},
  {"slug":"fade-in-on-load-4","name":"Fade in on Load 4","value":{"style":{"opacity":0,"x":"0px","y":"-10vh","z":"0vh"},"triggers":[{"type":"load","stepsA":[{"wait":"1500ms"},{"opacity":1,"transition":"opacity 500ms ease 0, transform 500ms ease 0","x":"0px","y":"0px","z":"0px"}],"stepsB":[]}]}},
  {"slug":"fade-in-on-scroll","name":"Fade in on Scroll","value":{"style":{"opacity":0,"x":"-10px","y":"0px","z":"0px"},"triggers":[{"type":"scroll","offsetBot":"6%","stepsA":[{"wait":200},{"opacity":1,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","x":"0px","y":"0px","z":"0px"}],"stepsB":[]}]}},
  {"slug":"fade-in-on-scroll-2","name":"Fade in on Scroll 2","value":{"style":{"opacity":0,"x":"0px","y":"10px","z":"0px"},"triggers":[{"type":"scroll","offsetBot":"6%","stepsA":[{"wait":400},{"opacity":1,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","x":"0px","y":"0px","z":"0px"}],"stepsB":[]}]}},
  ...
  {"slug":"fixed-popup-load","name":"fixed popup load","value":{"style":{"display":"none","opacity":0,"x":"0px","y":"-10px","z":"0px"},"triggers":[{"type":"load","preload":true,"stepsA":[{"wait":"3000ms"},{"display":"flex","opacity":1,"transition":"opacity 500ms ease 0, transform 500ms ease 0","x":"0px","y":"0px","z":"0px"}],"stepsB":[]}]}},
  {"slug":"new-interaction-2","name":"New Interaction 2","value":{"style":{},"triggers":[]}},
  {"slug":"new-interaction-3","name":"New Interaction 3","value":{"style":{},"triggers":[{"type":"click","selector":".fixed-popup","preserve3d":true,"stepsA":[{"opacity":0,"transition":"transform 500ms ease 0, opacity 500ms ease 0","x":"0px","y":"10px","z":"0px"},{"display":"none"}],"stepsB":[]}]}}
]);
